      ...
      <fieldset class="skio-plan-picker" role="radiogroup" aria-labelledby="skio-plan-picker-legend">
        ...
        ${
          this.selectedSellingPlan ?
            html`
              <div class="custom-picker-heading 11">
                Purchase Option: <span>${this.options?.subscription_title} ${this.discountText(this.selectedSellingPlan)}</span>
              </div>
            `
          :
            html`
              <div class="custom-picker-heading 22">
                Purchase Option: <span>${this.options?.onetime_title}</span>
              </div>
            `
        }
              ...
              >
                ...
                <label class="group-label" for="one-time-${this.key}">
                  <div class="group-topline">
                    ...
                    <div class="group-title 22">${this.options?.onetime_title ? this.options?.onetime_title : 'One time purchase'}</div>
                    ...
                    <div class="group-topline">
                      ...
                      <div class="group-title 11">
                        ${group.name !== 'Prepaid' && this.options?.subscription_title
                          ...
                          : group.name}
                        ${
                         html`<span class="extra-discount-text">${this.discountText(group.selected_selling_plan) ? this.discountText(group.selected_selling_plan) : ''}</span>`
                        }
                        ${this.discountText(group.selected_selling_plan)
                          ? html` <span class="savings ${this.options?.discount_style}"> SAVE ${this.discountText(group.selected_selling_plan)} </span> `
                          : html``}
                      </div>
